...
Préprocessing resnet qui prépare les images comme elles ont été traitées lors de l'entraînement initial du modèle, 
sur ImageNet.
- Conversion RGB → BGR
...
from pinkribbon.models import build_model_resnet50_2 as build_model
import gc
import optuna
